...
R53_SG_TAGS = { 'Name': 'route53health', 'AutoUpdate': 'true' }
...
def lambda_handler(event, context):
    ...
    SERVICE = os.getenv( 'SERVICE', "ROUTE53_HEALTHCHECKS")
    ...
    route53_health_ranges = get_ranges_for_service(ip_ranges, SERVICE, "REGION")

    # Update the security groups
    result = update_security_groups(route53_health_ranges, "REGION")
